...
To electrify a village, we setup microgrids that can store and distribute power. In our current work, we consider 2 microgrids, equipped with batteries storing solar and wind powers respectively. They also have electric lines connected from the main grid. Power supply is done in specific time slots, for example every 2 hours. Our goal is to intelligently use the stored power in batteries and take optimal action at every time slot to minimize the demand-supply deficit. 
